...
var API = /** @class */ (function () {
    function API(clientID, oauthToken, proxy) {
         ...
         */
        this.getURL = function (URI, params) { return __awaiter(_this, void 0, void 0, function () {
            var _a, response, _b, _c, response;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 2:
                        _d.trys.push([2, 4, , 7]);
                        return [4 /*yield*/, axios_1["default"].get(URI, { params: params, headers: API.headers }).then(function (r) { return r.data; })];
                    case 3:
                        response = _d.sent();
                        return [2 /*return*/, response];
                    case 4:
